...
public class MainMenuE implements ActionListener {
    ...
    MainMenuE() {
        ...
        PrintButton listener1 = new PrintButton();
        printButton.addActionListener(listener1);

        saveButton = new JButton("Save");
        SaveButton listener2 = new SaveButton();
        saveButton.addActionListener(listener2);

        exportButton = new JButton("Export");
        ExportButton listener3 = new ExportButton();
        exportButton.addActionListener(listener3);

        exitButton = new JButton("Exit");
        ExitButton listener4 = new ExitButton();
        exitButton.addActionListener(listener4);

        helpButton = new JButton("Help");
        HelpButton listener5 = new HelpButton();
            ...
            if (targetMat.toString().equals(None)) {
                ...
                if (("".equals(ionEnergy1.getText().trim())) || ("".equals(xAxisScaleFld.getText().trim()))) {
                    ...
                    try {
                        ...
                        cTE = new CalculationToolE(IncIons, ionEnergy1, targetMat, xAxisScaleFld, numClicks);
                        cTE.calc();
