...
public class CalculationToolE implements ActionListener {
    ...
    CalculationToolE(JComboBox incidentIonType, JTextField incidentIonEnergy, JComboBox targetMaterial, JTextField xAxisScaleFld, int numClicks) {
       // super();
    ...
    public void calc() {
        ...
        combinedArrays = new CombinedArrays(c14, c15, n, xAxisScale, incidentIonEnergy, symbol, numClicks);
    }
    //Clculating methods
