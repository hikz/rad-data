...
public class LineChartDemo2 extends ApplicationFrame {
    ...
    public LineChartDemo2(String title, double[][] final23, int n, int xAxisScale, double incidentIonEnergy, String symbol, int numClicks) {
        super(title);
        ...
        MainMenuE.jpnl3.add(cpnl);
        MainMenuE.box3.add(MainMenuE.jpnl3);
        int x = numClicks;
    }
